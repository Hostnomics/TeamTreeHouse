...
//Check to make sure we have the variables we need
if (!$firstName || !$lastName){
  ...
  echo "This is only for high school student. Please enter a grade between 9 and 12"; 
    ...
    if ($finalAverage < .70){
      $messageBody = "Summer School starts July 1st"; 
    } else {
        switch ($currentGrade) {
          case 9: 
            $messageBody = "Congrats on completing freshman year. See you Sept 1";
            break; 
          case 10: 
            $messageBody = "Congrats on completing sophmore year. See you Sept 1";
            break;
          case 11: 
            $messageBody = "Congrast on completing junior year. See you Sept 1";
            break; 
          case 12: 
            $messageBody = "Congrats, you completed high school."; 
            break; 
          default: 
